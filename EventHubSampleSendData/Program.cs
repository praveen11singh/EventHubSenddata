...
namespace SendSampleData
{
    class Program
    {
        ...
        const string connectionString = @"Endpoint=sb://pkeventhub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=LEtzzDlgvM6FLFlVPG/vW7XPqBfdrxeMv9W28C1BIlc=";

        public static async Task Main(string[] args)
        {
            await EventHubIngestionAsync();
            Console.WriteLine("completed the sending event");
        }
